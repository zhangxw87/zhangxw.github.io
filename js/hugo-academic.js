...
(function($){
  ...
  // buffer of whitespace between navbar and content
  $("#navMenu").resize(function () {
      $('#godown90').height($("#navMenu").height() + 10);
  });

  if ($("#navMenu").height() > $('#godown90').height()) $('#godown90').height($("#navMenu").height() + 10);

  $("#navMenu").resize(function () {
      $('#godown60').height($("#navMenu").height() + 10);
  });

  if ($("#navMenu").height() > $('#godown60').height()) $('#godown60').height($("#navMenu").height() + 10);
